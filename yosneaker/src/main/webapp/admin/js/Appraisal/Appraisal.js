var appraisal={
		serverUrl:'/admin/appraisal',		
		fmtOperate:function(val, row, index){
			return '<a href="javascript:void(0);" onclick="appraisal.openUpdate('+index+')">修改</a>'+
			'&nbsp;&nbsp;<a href="javascript:void(0);" onclick="appraisal.del('+val+')">删除</a>';
		},
		openCreate:function(){
