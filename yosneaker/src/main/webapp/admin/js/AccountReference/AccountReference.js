var accountReference={
		serverUrl:'/admin/accountReference',		
		fmtOperate:function(val, row, index){
			return '<a href="javascript:void(0);" onclick="accountReference.openUpdate('+index+')">修改</a>'+
			'&nbsp;&nbsp;<a href="javascript:void(0);" onclick="accountReference.del('+val+')">删除</a>';
		},
		openCreate:function(){
