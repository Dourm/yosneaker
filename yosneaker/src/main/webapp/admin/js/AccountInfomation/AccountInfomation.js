var accountInfomation={
		serverUrl:'/admin/accountInfomation',		
		fmtOperate:function(val, row, index){
			return '<a href="javascript:void(0);" onclick="accountInfomation.openUpdate('+index+')">修改</a>'+
			'&nbsp;&nbsp;<a href="javascript:void(0);" onclick="accountInfomation.del('+val+')">删除</a>';
		},
		openCreate:function(){
