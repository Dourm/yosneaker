var collection={
		serverUrl:'/admin/collection',		
		fmtOperate:function(val, row, index){
			return '<a href="javascript:void(0);" onclick="collection.openUpdate('+index+')">修改</a>'+
			'&nbsp;&nbsp;<a href="javascript:void(0);" onclick="collection.del('+val+')">删除</a>';
		},
		openCreate:function(){
